...
const sectionMostPopularity = document.querySelector(".movies-popularity");
const sectionLeastPopularity = document.querySelector(".movies-least-popularity");

ulElement.innerHTML = getMoviesList();
sectionPopularMovie.innerHTML = getMostPopularity();
sectionUnpopularMovie.innerHTML = getLeastPopularity();
